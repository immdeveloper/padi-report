...
(82, 1, 16, 'Price Information', '', '', 'Basic user', '', b'0'),
(83, 1, 16, 'Link from other pages', '', 'Special offers could be more prominent on the internal pages of the website', 'Webmaster', 'Try to include special offer text on the actual product pages so people do not have to travel to the special offers page to get the information.', b'0');
...
--
ALTER TABLE `assessment_detail`
  MODIFY `id_assessment_detail` int(11) NOT NULL AUTO_INCREMENT;
--
